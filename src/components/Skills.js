        ...
        <>
            ...
            <Paper className='Skill' sx={PaperStyle}>
                <Typography variant='p' sx={{fontSize: '1.5rem',display: 'block',marginLeft:'1%'}}>具体的な作品を作ったスキルにボタンがあります。</Typography>
                    ...
                    <SkillData Name='C#'src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/csharp/csharp-original.svg' alt='CSS' Content='高専5年次に第32回高専プログラミングコンテスト課題部門のソフトウェア作成にUnityと併用して使用した。' />
                    
                    <SkillData Name='JS' src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg' alt='JS' Content='高専5年次に第32回高専プログラミングコンテスト課題部門にバックエンドとして使用した。簡易的なゲームサーバとして利用するためExpress.jsとMySQLを併用し作成した。' />
                    ...
                    <SkillData Name="Python"src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" alt='Python' Content='大学時代の卒業研究で使用．主に用いるモジュールは numpy,matplotlib.pyplot,pandas'/>
